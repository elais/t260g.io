...
- [[./src/core.org][t260g.io.core]]

* Tests

- [[./test/core.org][t260g.io.test.core]]
...
https://github.com/elais/t260g.io
#+END_SRC

#+BEGIN_SRC clojure :exports none :noweb yes :noweb-ref cljs-artefact-path
target/t260g.io-<<version>>.js
#+END_SRC
...
#+BEGIN_SRC bash
  git clone https://github.com//t260g.io.git
  cd t260g.io
...
in the REPL via =(require 't260g.io... :reload)= or similar.

** Leiningen project file                                          :noexport:

#+BEGIN_SRC clojure :tangle babel/project.clj :noweb yes :mkdirp yes :padline no
  (defproject t260g.io "<<version>>"
...
The autogenerated namespace =t260g.io.version= contains a single
symbol =version= holding the version string defined above:

#+BEGIN_SRC clojure :noweb yes
  (use '[t260g.io.version])
...
#+BEGIN_SRC clojure :tangle babel/src/t260g\io/version.cljc :noweb yes :mkdirp yes :padline no :exports none
  (ns t260g.io.version)
...
|-----------+------------+--------------------+------------------------+---------------------|
|     0.1.0 | pending    | 1st public release | =[t260g.io "0.1.0"]= |                     |

** Contributors

| *Name*     | *Role*                          | *Website*      |
|------------+---------------------------------+----------------|
| [[][ejackson]] | initiator & principal developer |  |

** License

Copyright © 2015 ejackson
