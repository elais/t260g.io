...
* Contents                                                         :toc_3_gh:
 - [[#todo-namespace-ns-rootcore][TODO Namespace: t260g.io.core]]
...
#+BEGIN_SRC clojure :noweb-ref helpers
  <<lob-t260g.io-greetings(msg="hello world")>>

  (println
   "The result of" '<<lob-t260g.io-verbatim>> "is"
   <<lob-t260g.io-verbatim>>)
#+END_SRC

** Complete namespace definition

#+BEGIN_SRC clojure :tangle ../babel/src/t260g\io/core.cljc :noweb yes :mkdirp yes :padline no
  (ns t260g.io.core)
